			...
			<ol class="property-list tag">
				...
				<li class="fieldcontain">
					<span id="createdBy-label" class="property-label"><g:message code="tag.createdBy.label" default="Created By" /></span>
						...
						<span class="property-value" aria-labelledby="createdBy-label"><g:link controller="account" action="show" id="${tagInstance?.createdBy?.id}">${tagInstance?.createdBy?.encodeAsHTML()}</g:link></span>
