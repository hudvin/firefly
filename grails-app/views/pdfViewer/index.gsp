...
<head>
    ...
    <link rel="stylesheet" href="${resource(dir: 'pdfjs/web', file: 'viewer.css')}" />

    <script type="text/javascript" src="${resource(dir: 'pdfjs/web', file: 'compatibility.js')}"></script>



    <!-- This snippet is used in production, see Makefile -->
    <link rel="resource" type="application/l10n" href="${resource(dir: 'pdfjs/web/locale', file: 'locale.properties')}"/>
    <script type="text/javascript" src="${resource(dir: 'pdfjs/web', file: 'l10n.js')}"></script>
    <script type="text/javascript" src="${resource(dir: 'pdfjs/build', file: 'pdf.js')}"></script>


    <script type="text/javascript"  src="${resource(dir: 'pdfjs/web', file: 'debugger.js')}"></script>
