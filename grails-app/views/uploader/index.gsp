...
<head>
    ...
    <link rel="stylesheet" href="${resource(dir: 'jupl/css', file: 'style.css')}">
    ...
    <link rel="stylesheet" href="${resource(dir: 'jupl/css', file: 'jquery.fileupload-ui.css')}">
    <!-- CSS adjustments for browsers with JavaScript disabled -->
    <noscript><link rel="stylesheet" href="${resource(dir: 'jupl/css', file: 'jquery.fileupload-ui-noscript.css')}">
    </noscript>
    ...
    <tr class="template-download fade">
        ...
        <td>
            <button class="btn btn-danger delete" data-type="{%=file.delete_type%}"
                    data-url="{%=file.delete_url%}"{% if (file.delete_with_credentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>
            <i class="icon-trash icon-white"></i>
            <span>Delete</span>
        </button>
...
<script src="${resource(dir: 'jupl/js/vendor', file: 'jquery.ui.widget.js')}"></script>
...
<script src="${resource(dir: 'jupl/js/', file: 'jquery.iframe-transport.js')}"></script>
<!-- The basic File Upload plugin -->
<script src="${resource(dir: 'jupl/js/', file: 'jquery.fileupload.js')}"></script>
<!-- The File Upload file processing plugin -->
<script src="${resource(dir: 'jupl/js/', file: 'jquery.fileupload-fp.js')}"></script>
<!-- The File Upload user interface plugin -->
<script src="${resource(dir: 'jupl/js/', file: 'jquery.fileupload-ui.js')}"></script>
